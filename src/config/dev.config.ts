...
export const devConfig = {
  ...
  mailgun: {
    MAILGUN_PRIVATE_APIKEY: getEnv('MAILGUN_PRIVATE_APIKEY'),
    MAILGUN_PUBLIC_APIKEY: getEnv('MAILGUN_PUBLIC_APIKEY'),
    WEBHOOK_SIGNING_KEY: getEnv('WEBHOOK_SIGNING_KEY'),
    GATHEREASE_SENDING_APIKEY: getEnv('GATHEREASE_SENDING_APIKEY'),
